...
public class Reto2 {
    public static void main(String[] args) {
        ...
        // Ejemplo de como deberia salir: La enfermera Andrea le aplico una cantidad de dosis de vacuna de 1.25 litros al bebe jose con el peso de 4.5 kg y 2 meses de nacido del padre Alberto 
        // Limpiamos Buffer 
        capturar.close(); 
